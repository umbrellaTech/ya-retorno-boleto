...
//        $vlinha["valor_abatimento"] = $this->formataNumero(substr($linha, 228,
//                                                                  13)); //9  v99 Valor do abatimento
//        $vlinha["desconto_concedido"] = $this->formataNumero(substr($linha, 241,
//                                                                    13)); //9  v99 Desconto concedido 
...
//        $vlinha["outros_recebimentos"] = $this->formataNumero(substr($linha,
//                                                                     280, 13)); //9  v99 Outros recebimentos
//        $vlinha["abatimento_nao_aprov"] = $this->formataNumero(substr($linha,
//                                                                      293, 13)); //9  v99 Abatimento não aproveitado pelo sacado
//        $vlinha["valor_lancamento"] = $this->formataNumero(substr($linha, 306,
//                                                                  13)); //9  v99 Valor do lançamento
...
//        $vlinha["cob_simples_vlr_total"] = $this->formataNumero(substr($linha,
//                                                                       26, 14)); //9  v99 Cobrança Simples - valor total
...
//        $vlinha["cob_vinc_valor_total"] = $this->formataNumero(substr($linha,
//                                                                      66, 14)); //9  v99 Cobrança Vinculada - valor total
...
//        $vlinha["cob_cauc_vlr_total"] = $this->formataNumero(substr($linha, 106,
//                                                                    14)); //9  v99 Cobrança Caucionada - valor total
...
//        $vlinha["cob_desc_vlr_total"] = $this->formataNumero(substr($linha, 146,
//                                                                    14)); //9  v99 Cobrança Descontada - valor total
...
//        $vlinha["cob_vendor_vlr_total"] = $this->formataNumero(substr($linha,
//                                                                      226, 14)); //9  v99 Cobrança Vendor - valor total
